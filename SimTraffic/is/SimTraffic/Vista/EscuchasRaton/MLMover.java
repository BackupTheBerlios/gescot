...
/**
 * Escucha que permite recibir los eventos de ratón que suceden cuando el usuario se dispone
 * a mover los nodos sobre el mapa.
...
public class MLMover extends EscuchaRaton{
	...
	/**
	 * Punto en el que el usuario hace click inicialmente. Es el origen, la posicion relativa
	 * donde se encuentran los nodos inicialmente. 
	 */
	...
	/**
	 * Punto auxiliar que permite redibujar los nodos y tramos mientras se están desplazando.
	 */
