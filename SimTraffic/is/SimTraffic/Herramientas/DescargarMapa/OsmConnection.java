...
import is.SimTraffic.Herramientas.DescargarMapa.Base64;
...
public class OsmConnection {
	...
	private static class OsmAuth extends Authenticator {
		...
		@Override protected PasswordAuthentication getPasswordAuthentication() {
			...
			passwordtried = true;*/
			String username = new String("sorza555@hotmail.com");
			String password = new String("gescot");
	...
	public void cancel() {
		PleaseWaitDialog pwdAbort = new PleaseWaitDialog("Aborting...");
