...
import is.SimTraffic.Herramientas.DescargarMapa.EastNorth;
import is.SimTraffic.Herramientas.DescargarMapa.LatLon;

import is.SimTraffic.Herramientas.DescargarMapa.Projection;
import is.SimTraffic.Herramientas.DescargarMapa.SelectionManager.SelectionEnded;
...
public class WorldChooser extends NavigatableComponent {
	 ...
	 */
	public WorldChooser() {
		world = new ImageIcon(".//is/SimTraffic/Vista/Imagenes/world.jpg");
