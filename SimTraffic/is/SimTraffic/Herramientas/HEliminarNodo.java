...
public class HEliminarNodo implements IHerramienta 
{
   ...
   /**
    * Constructor que obtiene el nodo que se quiere eliminar y lo almacena en la herramienta.
    * @param nodo
 	*/
   ...
   /**
    * Aplica la herramienta sobre el modelo. En este caso, elimina el nodo especificado del mapa.
   ...
   /**
    * Deshace la aplicación realizada por la herramienta. En este caso, reinserta el nodo que fue 
    * eliminado.
   @param modelo Modelo que contiene toda la informacion de la aplicación.
   @return int Codigo de retorno. 0 indica que no hubo errores.
